const translation = {
  ...
  Index: {
    home: {
      greeting: "Hi, I'm Andy !",
      description:
        "Web developer with a solid foundation in design and development, committed to delivering quality results. Quick learner, adaptable to fast-paced environments.",
    },
    stack: {
      title: "Stacks and skills",
      subtitle: "Languages, frameworks and libraries I comfortable with",
      language: "Languages",
      framework: "Frameworks and Libraries",
      dbandorm: "Database and Object Relational Mapping",
      tool: "Tools",
      more: "Discover more",
      "3d": "3D modeling and rendering",
      ai: "AI / ML and related tools",
    },
    works: {
      title: "Works",
      subtitle: "Accomplished project",
      viewproject: "View project",
      computervision: {
        title: "Deep learning technology for object detection in libraries",
        description:
          "Automated assistant for library surveillance and management.",
      },
    },
  },
  Work: {
  ...
  About: {
    home: {
      ...
      title: "About me",
      presentation:
        "Since high school, I've worked on diverse projects across industries like supply web development, AI, and cloud architectures. Growing up in a multicultural environment honed my language skills and interpersonal abilities, which I leverage in both professional and personal interactions.",
      experience:
        "I thrive on hands-on project development, covering frontend, backend, and recent focuses on software and cloud architectures. My corporate experience offers deep insights into strategic decision-making, including budgeting, prioritization, and seizing opportunities.",
      hobby:
        "When I'm not working, I enjoy tending to the things that matter most to me, such as maintaining a clean and organized home and prioritizing my health and well-being. Additionally, I have a profound passion for aviation and find solace in spending time at the airport, soaking in the atmosphere and taking moments to unwind. If you have an opportunity you'd like to discuss further, please don't hesitate to reach out to me!",
    },
    experiences: {
      title: "Experiences",
      infotech: {
        ...
        content: {
          core: {
            ...
            detail:
              "Throughout the development lifecycle, our collective experiences drove us to enhance the deployment system. We automated everything—from end-to-end testing and component testing to containerization. Similarly, during the deployment phase, I acquired proficiency in continuous integration and continuous deployment using GitLab's native tools.",
          },
          webapp: {
            title: "Web application - Development",
            detail:
              "As a contributor to the company's new project, I actively participated in all phases of application development. From collaborating with software architects, UI/UX design to meticulously overseeing quality assurance, I worked closely with each production team member. This hands-on involvement provided invaluable insights into the entire development lifecycle.",
          },
        },
      },
      university: {
    ...
    certificates: {
      ...
      excellence: {
        title: "Excellence in Research Project",
        description:
          "This prestigious award is presented personally by the Dean of the Department of Computer Science and Information Engineering to recognize the five project groups with the best performance in the department.",
      },
      jury: {
        title: "Jury Favorite Research Project",
        description:
          "Invited by Ming Chuan university, some IT professionals anonymously participated in our final project exhibition. They had to judge our work, based on the presentation we gave and the product we shown during the event.",
      },
    },
  },
};
