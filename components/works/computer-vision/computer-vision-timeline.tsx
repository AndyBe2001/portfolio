...
import { WorkTimelineItem } from "../work-timeline-item";
...
export const ComputerVisionTimeline = async () => {
  ...
  return (
    <section className="mx-auto mb-16 max-w-6xl">
      ...
      <WorkTimeline className="mx-auto grid w-fit grid-cols-[auto_auto] grid-rows-[auto_auto_auto] gap-x-8 sm:w-full sm:grid-flow-col sm:grid-cols-4 sm:grid-rows-[auto_auto] sm:gap-x-0 sm:gap-y-4">
        <WorkTimelineItem
